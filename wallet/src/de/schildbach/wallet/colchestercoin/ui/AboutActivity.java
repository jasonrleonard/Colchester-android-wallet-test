...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_colchestercoinJ = "about_credits_colchestercoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_colchestercoinJ).setTitle(getString(R.string.about_credits_colchestercoinj_title, VersionMessage.BITCOINJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_colchestercoinJ).setSummary(Constants.CREDITS_colchestercoinJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_colchestercoinJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_colchestercoinJ_URL)));
			finish();
		}
